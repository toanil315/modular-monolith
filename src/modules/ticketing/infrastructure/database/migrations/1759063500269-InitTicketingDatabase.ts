...
export class InitTicketingDatabase1759063500269 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ticketing"."ticket_types" ("id" uuid NOT NULL, "event_id" uuid NOT NULL, "name" character varying(255) NOT NULL, "price" numeric(12,2) NOT NULL, "currency" character varying(10) NOT NULL, "quantity" integer NOT NULL, "available_quantity" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_5510ce7e18a4edc648c9fbfc283" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
